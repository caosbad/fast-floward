...
pub contract RegistryNFTContract: NonFungibleToken, RegistryInterface {
    ...
    pub resource interface ItenantPrivate{
        pub fun mintNFT(recipient: &RegistryNFTContract.Collection{NonFungibleToken.CollectionPublic}, metadata: {String: String})
    }
    ...
    // 
    pub resource Tenant: ITenant, ItenantPrivate {
        ...
        pub fun mintNFT(recipient: &RegistryNFTContract.Collection{NonFungibleToken.CollectionPublic}, metadata: {String: String}) {
            ...
            &self.minter.mintNFT(recipient: &RegistryNFTContract.Collection{NonFungibleToken.CollectionPublic}, metadata: {String: String})
            self.updateTotalSupply()
        }
    ...
    init() {
        ...
        self.TenantPrivatePath = /private/RegistryNFTContractTenant
