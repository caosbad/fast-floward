...
transaction() {
  ...
  prepare(acct: AuthAccount) {
    ...
    if acct.borrow<&RegistryNFTContract.Tenant>(from: /storage/NFTContract) == nil {
      ...
      acct.link<&RegistryNFTContract.Tenant{RegistryNFTContract.ITenantPrivate}>(RegistryNFTContract.TenantPrivatePath, target: RegistryNFTContract.TenantStoragePath)
    }
  }
