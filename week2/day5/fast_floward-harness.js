  ...
  render() {
    let content = html`
      <page-body title="${this.title}" category="${this.category}" description="${this.description}">
        ...
        <action-card title="DAY 5: Kibble - Burn Tokens" description="Burn Kibble into an account" action="kibbleBurnTokens"
        ...
        <action-card title="DAY 4: Kitty Items Market - Sell Market Item"  action="kittyItemsMarketSellMarketItem" method="post" fields="itemID price">
          <account-widget field="signer" label="Signer">
          </account-widget>
          <text-widget field="itemID" label="Item ID" placeholder="5"></text-widget>
          <text-widget field="price" label="Amount" placeholder="20.0"></text-widget>
        ...
        <!-- TODO: Implement this action card -->
        <!-- NOTE: This is a transaction -->
        <action-card title="DAY 4: Kitty Items Market - Buy Market Item" action="kittyItemsMarketBuyMarketItem" method="post" fields="signer itemID marketCollectionAddress">
          <account-widget field="signer" label="Signer">
          </account-widget>
          <text-widget field="itemID" label="Item ID" placeholder="5"></text-widget>
        ...
        <action-card title="DAY 4: Kitty Items Market - Read Sale Collection IDs" action="kittyItemsMarketReadSaleCollectionIDs" method="get" fields="marketCollectionAddress">
